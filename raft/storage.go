...
func (ms *MemoryStorage) Compact(compactIndex uint64) error {
	...
	//in order to reduce the possibility of expanding slice when appending log.
...
func (ms *MemoryStorage) Append(entries []pb.Entry) error {
	...
	//[question]impossible to overwrite stable entries? need to know context of entries which are needed to append.
